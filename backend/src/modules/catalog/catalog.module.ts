...
@Module({
  imports: [TypeOrmModule.forFeature([IssueType, Label, IssueLinkType, Priority, Resolution, OrganizationMember]), PermissionModule, AuthModule],
  controllers: [CatalogController],
  providers: [CatalogService, OrgPermissionGuard, OrgMembershipGuard],
